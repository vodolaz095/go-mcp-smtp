...
type SendRawInput struct {
	Recipients string `json:"name" jsonschema:"list of recipients in RFC 5322 format like \"John Dow <john.dow@example.com>, Jane Dow <jane.dow@example.com>\" or even \"jane.doe@example.org\""`
